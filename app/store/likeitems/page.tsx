...
export default function Products() {
    ...
    const cartItems = useCartStore((state) => state.likes);
    const removeItem = useCartStore((state) => state.removeLikes);
    const updateQuantity = useCartStore((state) => state.updateLikeQuantity);
    ...
    const columns: ColumnDef<CartItem>[] = [
        ...
        },
        {
            ...
            cell: ({ getValue }) => {
                ...
                return `₹${Number(value).toLocaleString("en-IN")}`; // ₹1,00,000 format
            }
        }
        ,
        {
    ...
    return (
        <div className="p-3 mt-3 h-auto">
            ...
            {cartItems.length != 0 ? (
                ...
                <div>
                    <div className="h-120 flex items-center justify-center w-full">
